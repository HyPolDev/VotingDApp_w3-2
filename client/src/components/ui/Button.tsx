...
const Button = ({ className, fill, icon, position, handleClick }: ButtonProps) => {
    return (
        <div className={className} >
            <button onClick={() => handleClick} className="relative inline-flex h-12 w-full overflow-hidden rounded-full p-[4px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 ">
